  ...
  <div class="wrapper container">
      ...
      <nav class="navbar navbar-default">
          <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="/rates">Текущий курс</a></li>
      ...
      <div class="heading">
          <h1><spring:message code="label.currentRate" /></h1>
      </div>
      <div class="row">
              ...
              <div class = "text-success">
                  <c:if test="${!empty contactList}">
                      <table id="currency-table" class="table table-hover table-bordered" >
                          ...
                          <tbody>
                          <tr>
                              <td><spring:message code="label.privat" /></td>
                              <td>${current1.TTime}</td>
                              <td>${current1.USDbuy}</td>
                              <td>${current1.USDsell}</td>
                              <td>${current1.EURbuy}</td>
                              <td>${current1.EURsell}</td>
                          </tr>
                          <tr>
                              <td><spring:message code="label.PravexBank" /></td>
                              <td>${current2.TTime}</td>
                              <td>${current2.USDbuy}</td>
                              <td>${current2.USDsell}</td>
                              <td>${current2.EURbuy}</td>
                              <td>${current2.EURsell}</td>
                          </tr><tr>
                              <td><spring:message code="label.UkrSibbank" /></td>
                              <td>${current3.TTime}</td>
                              <td>${current3.USDbuy}</td>
                              <td>${current3.USDsell}</td>
                              <td>${current3.EURbuy}</td>
                              <td>${current3.EURsell}</td>
                          </tr><tr>
                              <td><spring:message code="label.XBank" /></td>
                              <td>${current4.TTime}</td>
                              <td>${current4.USDbuy}</td>
                              <td>${current4.USDsell}</td>
                              <td>${current4.EURbuy}</td>
                              <td>${current4.EURsell}</td>
                          </tr>
                          <tr>
                              <td><spring:message code="label.PUMB" /></td>
                              <td>${current5.TTime}</td>
                              <td>${current5.USDbuy}</td>
                              <td>${current5.USDsell}</td>
                              <td>${current5.EURbuy}</td>
                              <td>${current5.EURsell}</td>
                          </tr>
                          <tr>
                              <td><spring:message code="label.AlfaBank" /></td>
                              <td>${current6.TTime}</td>
                              <td>${current6.USDbuy}</td>
                              <td>${current6.USDsell}</td>
                              <td>${current6.EURbuy}</td>
                              <td>${current6.EURsell}</td>
                          </tr>
                          <tbody>
                      </table>
                  </c:if>
